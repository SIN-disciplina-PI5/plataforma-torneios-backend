    ...
    include: [
      {
        model: Usuario,
        as: "usuario",
        attributes: ["id_usuario", "nome", "email", "foto_perfil"],
      },
      {
        model: Torneio,
        as: "torneio",
  ...
  return inscricoes.map((i) => ({
    ...
    usuario: i.usuario
      ? {
          ...
          foto_perfil: i.usuario.foto_perfil,
        }
      : { id: i.id_usuario },
    torneio: i.torneio
      ? {
...
export const deleteInscricaoService = async (id, usuarioLogado = null) => {
  ...
  if (equipe) {
    await sairDaEquipeService(inscricao.id_torneio, inscricao.id_usuario);
  }
    ...
    include: [
      {
        model: Usuario,
        as: "usuario",
        attributes: ["id_usuario", "nome", "email", "patente", "foto_perfil"],
      },
    ],
